    ...
    .run(function ($ionicPlatform, $cordovaSQLite) {
        $ionicPlatform.ready(function () {
            ...
            if (window.cordova) {
                ...
                db = $cordovaSQLite.openDB("CuantoGanoDBv3.0");
                ...
                db = window.openDatabase("CuantoGanoDBv3.0", '1', 'my', 1024 * 1024 * 100); // browser
