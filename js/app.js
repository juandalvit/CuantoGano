    ...
    .run(function ($ionicPlatform, $cordovaSQLite) {
        $ionicPlatform.ready(function () {
            ...
            if (window.cordova) {
                ...
                //Clean DB
                $cordovaSQLite.deleteDB("CuantoGanoDBv2.1");

                db = $cordovaSQLite.openDB("CuantoGanoDBv2.3");
